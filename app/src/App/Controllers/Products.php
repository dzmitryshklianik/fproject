...
class Products extends Controller
{
    ...
    public function index():Response
    {
        ...
        return $this->view("Products/index.mvc.php", [
            "products" => $products, "total" => $this->model->getTotal()
        ]);
    }
    ...
    public function create(): Response
    {
        ...
        if($this->model->insert($data)){
            ...
            return $this->redirect("/products/{$this->model->getLastInsertId()}/show");
        }
        else{

            return $this->view("Products/new.mvc.php",
                ["errors"=>$this->model->getErrors(),"product"=>$data]);
    ...
    public function update(string $id): Response
    {
        ...
        if($this->model->update($id, $product)){
            ...
            return $this->view("Products/edit.mvc.php",["errors"=>$this->model->getErrors(),"product"=>$product]);
